...
public class LieuDao {
    ...
    public static void create(Lieu lieu) throws Throwable {
    ...
    public static Lieu findById(int id) throws Throwable {
        EntityManager em = JpaUtil.obtenirEntityManager();
        Lieu lieu = null;
        try {
    ...
    public static List<Lieu> findAll() throws Throwable {
        EntityManager em = JpaUtil.obtenirEntityManager();
